...
#End If
        ...
        <Global.System.Configuration.ApplicationScopedSettingAttribute(),  _
         ...
         Global.System.Configuration.DefaultSettingValueAttribute("http://biglietti.mailticket.it/ServizioRemoto.asmx")>  _
        Public ReadOnly Property VisualizzaBiglietti_wsTicket_ServizioRemoto() As String
            Get
                Return CType(Me("VisualizzaBiglietti_wsTicket_ServizioRemoto"),String)
            End Get
        End Property
    End Class
End Namespace
